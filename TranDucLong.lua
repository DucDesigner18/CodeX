...
local Window = Fluent:CreateWindow({
    Title = "BatMan Hub | Dev : TranDucLong",
    SubTitle = "https://zalo.me/g/ckkajt952",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=79647060768113"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Sự Kiện ( Only Max Level )",Description = "Cày sự kiện ( Chỉ Cấp Độ Tối Đa )", Default = false })
