...
local Window = OrionLib:MakeWindow({Name = "FREE FIRE (BETA)", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "FREE FIRE (BETA)"})
...
OrionLib:MakeNotification({
	Name = "FREE FIRE (BETA)",
	Content = "FREE FIRE (BETA) Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By Duc")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] FREE FIRE (BETA)")
W:AddLabel("[+] FREE FIRE (BETA)")
W:AddLabel("[+] FREE FIRE (BETA)")
...
local locallv = W:AddLabel("Level")
    ...
    W:AddLabel("[+] VN: Redz999 và MinGaming dell là gì với tao!!!")
    -- W:AddLabel("Bố mày ghét nhất lũ sv mõm tự tôn tự cao !")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "FREE FIRE (BETA)(Noitification)",
...
OrionLib:MakeNotification({
    Name = "FREE FIRE (BETA) (BETA)",
    Content = "Loading Config Complete!!",
    Image = "rbxassetid://127393374937080",
    Time = 5
})